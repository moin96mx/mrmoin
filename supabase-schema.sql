...
drop policy if exists "Anyone can submit course enrollments" on public.course_enrollments;
drop policy if exists "Admins can read course enrollments" on public.course_enrollments;
drop policy if exists "Admins can update course enrollments" on public.course_enrollments;
